...
describe('MetabolicWeightManagementCategoryPage', () => {
  it('renders the shared Retatrutide-led decision path with data-derived products and pricing', () => {
    ...
    expect(html).toContain('View full pricing')
  ...
  it('renders the complete Spanish conversion path without English shell copy', () => {
    ...
    expect(html).toContain('Investigación de la vía GH–IGF-1')
    expect(html).toContain('Péptido derivado de mitocondrias')
    expect(html).toContain('Investigación de fragmento de GH')
    expect(html).toContain('Dos señales de investigación del eje GH')
