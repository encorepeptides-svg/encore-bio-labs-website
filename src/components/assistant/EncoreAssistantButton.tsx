...
export function EncoreAssistantButton({ onClick }: { onClick: () => void }) {
  ...
  return (
    <button
      ...
      className="group fixed bottom-24 right-4 z-[70] flex size-14 items-center justify-center rounded-full border border-white/60 bg-white/75 p-2 text-sm font-semibold text-[var(--navy)] shadow-[0_18px_50px_rgba(26,35,64,0.18)] backdrop-blur-2xl transition duration-300 hover:-translate-y-1 hover:bg-white md:bottom-6 md:right-6 xl:h-14 xl:w-auto xl:gap-2.5 xl:py-2 xl:pl-2.5 xl:pr-5"
    >
