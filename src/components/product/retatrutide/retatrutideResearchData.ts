...
export const researchBenefits: RetatrutideResearchBenefit[] = [
  ...
  },
  {
    ...
    description: 'Research results also included changes in triglycerides, non-HDL cholesterol, systolic blood pressure and inflammatory markers. These marker changes do not establish prevention of cardiovascular events.',
  ...
  },
  {
    ...
    description: 'An embedded Phase 3 study evaluated changes in obstructive sleep-apnea severity, reporting fewer breathing-disruption events per hour in trial participants. The results do not establish a cure or support discontinuing prescribed care.',
    evidenceLevel: 'phase-3',
