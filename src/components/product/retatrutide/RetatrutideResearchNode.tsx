...
const outcomeLabelKeys: Record<RetatrutideResearchOutcome['icon'], string> = {
  weight: 'outcomeWeightLabel',
  glucose: 'outcomeGlucoseLabel',
  waist: 'outcomeWaistLabel',
  lipid: 'outcomeLipidLabel',
  pressure: 'outcomePressureLabel',
  mobility: 'outcomeMobilityLabel',
  sleep: 'outcomeSleepLabel',
}

const outcomeMetricValueKeys: Partial<Record<RetatrutideResearchOutcome['icon'], string>> = {
  glucose: 'glucoseA1cMetricValue',
}
