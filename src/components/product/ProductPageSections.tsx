        ...
        <div className="mx-auto grid max-w-[82rem] items-center gap-6 lg:grid-cols-[1fr_1.12fr]">
          ...
          <div className="order-last lg:order-none">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <p className="inline-flex rounded-full border border-teal-700/20 bg-teal-700/10 px-4 py-2 text-[0.66rem] font-semibold uppercase tracking-[0.18em] text-teal-800">{product.badge}</p>
              <p className="inline-flex rounded-full border border-slate-900/10 bg-white px-4 py-2 text-[0.66rem] font-semibold uppercase tracking-[0.18em] text-slate-700">{priceLabel}</p>
            </div>
