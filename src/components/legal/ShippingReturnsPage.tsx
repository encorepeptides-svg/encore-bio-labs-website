...
const copy = {
  en: {
    ...
    mexicoLocalNote: 'For local delivery in Ciudad Juárez or Chihuahua, the same $25 or $50 import fee applies. The $15 carrier-shipping charge does not apply; the configured local-delivery cost is shown separately.',
    ...
    localBody: 'Local delivery may be available in El Paso, Ciudad Juárez, and Chihuahua. The exact address must fall inside the configured zone. Ciudad Juárez and Chihuahua also include the applicable Mexico import fee. Until a zone, fee, and time are configured, checkout shows “Availability and cost pending confirmation” and requests manual review.',
  ...
  es: {
    ...
    mexicoLocalNote: 'Para entrega local en Ciudad Juárez o Chihuahua aplica la misma tarifa de importación de $25 o $50. No se cobran los $15 de paquetería; el costo configurado de entrega local se muestra por separado.',
    ...
    localBody: 'La entrega local puede estar disponible en El Paso, Ciudad Juárez y Chihuahua. La dirección exacta debe estar dentro de la zona configurada. Ciudad Juárez y Chihuahua también incluyen la tarifa de importación correspondiente a México. Mientras no estén configurados la zona, el costo y el horario, el checkout muestra “Disponibilidad y costo por confirmar” y solicita revisión manual.',
