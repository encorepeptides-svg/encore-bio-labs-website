...
const copy = {
  en: {
    ...
    localBody: 'For a local order in El Paso or Ciudad Juárez, choose free pickup at the configured distribution point or $10 home delivery. The 10-mile home-delivery radius is centered on distribution postal code 79912 for El Paso and 32510 for Ciudad Juárez. The server measures the carrier-verified address against the applicable postal-code center. The pickup location and schedule are shown after confirmation. Ciudad Juárez also includes the applicable Mexico import fee. Chihuahua city is served by tracked carrier shipping rather than local stock: choose Mexico at checkout and the same import fee and order-value benefits apply. If the address, radius, or timing cannot be confirmed, checkout requests manual review and does not invent availability.',
