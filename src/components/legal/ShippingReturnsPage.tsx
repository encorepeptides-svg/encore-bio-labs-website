...
const copy = {
  en: {
    ...
    localBody: 'For a local order in El Paso, Ciudad Juárez, or Chihuahua, choose free pickup at the configured distribution point or $10 home delivery. The 10-mile home-delivery radius is centered on distribution postal code 79912 for El Paso, 32510 for Ciudad Juárez, and 31200 for Chihuahua. The server measures the carrier-verified address against the applicable postal-code center. The pickup location and schedule are shown after confirmation. Ciudad Juárez and Chihuahua also include the applicable Mexico import fee. If the address, radius, or timing cannot be confirmed, checkout requests manual review and does not invent availability.',
  ...
  es: {
    ...
    mexicoLocalNote: 'Para pedidos locales en Ciudad Juárez o Chihuahua aplica la misma tarifa de importación de USD $25 o USD $50, tanto para recoger en punto de distribución como para entrega a domicilio. No se cobran los USD $15 de paquetería. Recoger es gratis; la entrega a domicilio elegible agrega USD $10.',
    ...
    localBody: 'Para un pedido local en El Paso, Ciudad Juárez o Chihuahua, elige recoger gratis en el punto de distribución configurado o entrega a domicilio por USD $10. El radio de 10 millas se centra en el código postal de distribución 79912 para El Paso, 32510 para Ciudad Juárez y 31200 para Chihuahua. El servidor mide la dirección verificada por el transportista contra el centro del código postal correspondiente. El lugar y horario de recogida se muestran después de confirmarlos. Ciudad Juárez y Chihuahua también incluyen la tarifa de importación aplicable a México. Si no se pueden confirmar la dirección, el radio o el horario, el checkout solicita revisión manual y no inventa disponibilidad.',
