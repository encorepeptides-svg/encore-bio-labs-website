...
export function DistributorAdminPage({ section = 'overview' }: { section?: string }) {
  ...
  return <PortalShell admin>
    ...
    {['configuration','rules','profitability','resources','managers','security'].includes(section) && identity ? <DistributorAdminPremium section={section} accounts={data.accounts} userId={identity.user.id} locale={locale} /> : null}
  </PortalShell>
}
