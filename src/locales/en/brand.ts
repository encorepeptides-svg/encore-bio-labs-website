export const brand = {
  ...
  researchLibraryDisclaimer: 'Educational content only. Not medical advice. Not a substitute for reading primary research.',
  intakeDisclaimer: 'Encore Bio Labs provides research-use-only educational information. The intake does not provide medical advice, diagnosis, treatment, prescription guidance, dosing guidance, or clinical care.',
  researchUsePoint1: 'We supply these materials for laboratory research use only',
