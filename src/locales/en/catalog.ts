export const catalog = {
  ...
  heroVisualAlt: 'Encore Bio Labs complete research kit with syringes, BAC water, research vial, and alcohol preparation pads',
  ...
  retaBody:
    'Retatrutide is an investigational triple agonist studied across GIP, GLP-1, and glucagon receptor signaling. Its multi-pathway design places it at the intersection of nutrient signaling, energy-balance, and body-composition research.',
  retaReceptorsLabel: 'Receptor pathways studied',
  retaReceptorGip: 'GIP',
  ...
  closingBody:
    'Encore Bio Labs supplies every catalog item for controlled laboratory research. The catalog does not present these materials for human or veterinary use, diagnosis, treatment, or administration.',
  ...
  jumpToCategory: 'Jump to a catalog collection',
  categoryAll: 'All',
  categoryWeightManagement: 'Metabolic Research',
  categoryRecoveryRegeneration: 'Recovery & Regeneration',
  categoryCognitivePerformance: 'Cognitive Research',
  categoryCellularEnergyLongevity: 'Cellular Energy & Longevity',
  categoryHormoneWellness: 'Hormone & Wellness',
  ...
  activeSearchSummary: 'Showing results for “{query}”',
  activeCategorySummary: 'Category: {category}',
