export const catalog = {
  ...
  // Retatrutide feature
  retaEyebrow: 'THREE PATHWAYS. ONE MOLECULE.',
  ...
  retaSelectedPrice: 'Selected price',
  retaVariantReference: 'Variant',
  retaUnavailable: 'Unavailable',
  retaUnavailableDescription: '{variant} is currently unavailable and cannot be selected.',
