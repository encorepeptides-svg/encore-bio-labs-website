...
export const faq = {
  ...
  featuredProductDescription: 'Descubre cómo una página de producto presenta variantes, documentos de laboratorio, lenguaje de uso exclusivo para investigación e investigación relacionada.',
  trustLabel: 'Confianza y cumplimiento',
  trustTitle: 'Sobre los estándares de Encore Bio Labs',
  trustDescription: 'Conoce cómo los documentos de laboratorio, la estructura por categorías y la revisión humana dan forma al catálogo.',
