...
export const categories = {
  ...
  metabolicWeightManagementDescription: 'Explora productos relacionados con la señalización metabólica, la regulación de energía y la investigación de composición corporal.',
  recoveryRegenerationTitle: 'Recuperación y regeneración',
  recoveryRegenerationDescription: 'Productos estudiados en reparación de tejidos, señalización del tejido conectivo e investigación de recuperación.',
  ...
  cognitivePerformanceDescription: 'Explora productos relacionados con el enfoque, la cognición, la señalización neurológica y el rendimiento.',
  hormoneWellnessTitle: 'Hormonas y bienestar',
  hormoneWellnessDescription: 'Investigación sobre señalización endocrina, productos relacionados con hormonas y vías de bienestar.',
