...
export const brand = {
  ...
  documentationPromise: 'Nuestro equipo confirma qué documentos de laboratorio de identidad, pureza, almacenamiento y lote aplica durante la revisión del producto.',
  ...
  catalogPositioning: 'Explora reactivos de grado investigación y orientados a GMP, organizados para adquisición empresarial, revisión de documentos de laboratorio y compras por volumen.',
  researchUseLabel: 'Uso exclusivo para investigación',
  documentationLabel: 'Documentos de laboratorio disponible a solicitud',
  ...
  researchLibraryDisclaimer: 'Contenido únicamente educativo. No es un consejo médico. No sustituye la lectura de las investigaciones originales.',
  intakeDisclaimer: 'Encore Bio Labs ofrece información educativa de uso exclusivo para investigación. Este formulario no brinda consejo médico, diagnóstico, tratamiento, orientación de prescripción, guía de dosificación ni atención clínica.',
  researchUsePoint1: 'Suministramos estos materiales únicamente para investigación de laboratorio',
