...
export const catalog = {
  ...
  klowVisualAlt: 'Vial KLOW con GHK-Cu, BPC-157, TB-500 y KPV para uso exclusivo de investigación',

  // Retatrutide feature
  retaEyebrow: 'El compuesto metabólico más solicitado',
  retaTitle: 'Retatrutide',
  retaPullQuote: 'Cinco concentraciones. Un agonista triple. Elige la opción que buscas.',
  retaBody:
    'Compara 10, 15, 20, 25 y 30 mg en una sola página. Revisa precio, documentación y contexto de las vías GIP, GLP-1 y glucagón antes de ordenar.',
  ...
  retaPrimaryCta: 'Elegir Retatrutide',
  retaSecondaryCta: 'Ver concentraciones',
