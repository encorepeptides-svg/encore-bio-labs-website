...
export const catalog = {
  ...
  bacWaterVisualAlt: 'Vial de agua BAC Encore Bio Labs de 1 mL incluido como componente correspondiente del kit completo',
  ...
  klowCta: 'Ver KLOW y precios',
  klowCompliance: 'Uso exclusivo para investigación. No destinado a uso humano ni veterinario.',
  klowVisualAlt: 'Vial de la mezcla KLOW etiquetado con GHK-Cu, BPC-157, TB-500 y KPV para uso exclusivo de investigación',

  // Retatrutide feature
  retaEyebrow: 'TRES VÍAS. UNA SOLA MOLÉCULA.',
  ...
  retaSelectedPrice: 'Precio seleccionado',
  retaVariantReference: 'Variante',
  retaUnavailable: 'No disponible',
  retaUnavailableDescription: '{variant} no está disponible actualmente y no se puede seleccionar.',
  ...
  fullPricingOnProductPage: 'Consulta los precios de cada concentración, Producto Solo, Kit Completo y paquetes múltiples en la página del producto.',
  viewProductPricing: 'Ver producto y precios',
  ...
  viewOptions: 'Ver producto y precios',
  view: 'Ver precios',
  ...
  categoryAll: 'Todos',
  categoryWeightManagement: 'Metabolismo y control de peso',
  categoryRecoveryRegeneration: 'Recuperación y regeneración',
  categoryCognitivePerformance: 'Investigación cognitiva',
  categoryCellularEnergyLongevity: 'Longevidad y salud celular',
