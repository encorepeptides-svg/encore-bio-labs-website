...
export const productResearchContent: Record<string, ProductResearchContent> = {
  tesamorelin: {
    ...
    mechanismSummary: 'Tesamorelin is investigated as a GHRH-receptor activator that increases pulsatile pituitary GH release and downstream IGF-1 signaling. Measured metabolic outcomes remain population- and study-specific.',
    mechanismSteps: [
    ...
    limitations: ['Human evidence is concentrated in specific HIV-associated abdominal-adiposity populations.', 'Imaging and laboratory endpoints do not establish broadly generalizable outcomes.', 'IGF-1 and glucose-related results require careful interpretation within each study design.', 'Published pharmaceutical trials do not verify the identity, purity, or performance of third-party research materials.'],
    faq: [
      { question: 'What type of product is Tesamorelin?', answer: 'Tesamorelin is a synthetic peptide analog of growth-hormone-releasing hormone studied at the GHRH receptor and downstream GH/IGF-1 axis.' },
  ...
  'wolverine-stack': {
    ...
    limitations: ['No cited study evaluates the Encore combination product as a combined intervention.', 'BPC-157 evidence shown is animal-model evidence, not controlled human evidence.', 'Thymosin beta-4 results shown include in-vitro and other preclinical models.', 'Component results cannot establish synergy, clinical benefit, safety, or expected individual outcomes.'],
    faq: [
      { question: 'Is Wolverine Stack one molecular product?', answer: 'No. It is a combination catalog entry organized around BPC-157 and TB-500 research themes.' },
