...
export const protocols: ProtocolConfig[] = [
  ...
  },
  {
    ...
    content: {
      ...
      education: {
        en: ['Wolverine Stack is a finished blend entry, while GHK-Cu remains a separate product with selectable strength and its own lab paperwork context.', 'The bundle is a catalog convenience only. It does not direct use, timing, administration, or expected outcomes.'],
  ...
  },
  {
    ...
    content: {
      ...
      description: t('Groups Kisspeptin, HCG, and DSIP for qualified teams comparing reproductive, fertility hormone, and sleep-linked signaling contexts.', 'Agrupa Kisspeptin, HCG y DSIP para equipos calificados que comparan contextos reproductivos, gonadotrópicos y de señalización vinculada al sueño.'),
...
export const protocolFaqs = {
  en: [
    ...
    { question: 'What lab paperwork is available?', answer: 'On-file COAs are linked only where Encore has a reviewed record. Other lot, identity, handling, and availability records may be requested; lab paperwork varies by product and batch.' },
