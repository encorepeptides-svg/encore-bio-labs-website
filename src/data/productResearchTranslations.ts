...
export function localizeProductResearchContent(product: Product, content: ProductResearchContent, locale: Locale): ProductResearchContent {
  ...
  return {
    ...
    studies: content.studies.map((study) => ({
      ...
      keyFinding: 'El estudio informa resultados dentro del modelo descrito; no establece resultados individuales ni valida materiales de catálogo.',
    ...
    limitations: [
      ...
      'Los resultados publicados no garantizan identidad, pureza o desempeño de un material de terceros.',
