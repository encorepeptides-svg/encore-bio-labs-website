...
const contentTypeLabelsEs: Record<ResearchContentType, string> = {
  'deep-dive': 'Análisis de producto',
...
const contentTypeDescriptionsEs: Record<ResearchContentType, string> = {
  'deep-dive': 'Contexto del producto, vías estudiadas y límites de la evidencia disponible.',
...
const glossaryTermsEs: GlossaryTerm[] = [
  ...
  { term: 'Péptido', definition: 'Cadena corta de aminoácidos unidos entre sí; es más pequeña que una proteína completa y forma la base estructural de muchos productos del catálogo.' },
  { term: 'Liofilización', definition: 'Proceso de secado por congelación que elimina el agua para estabilizar un producto durante el almacenamiento y produce el polvo o sólido presente en muchos viales.' },
  { term: 'Reconstitución', definition: 'Proceso de disolver un producto liofilizado en un diluyente líquido dentro de un entorno de investigación calificado.' },
  ...
  { term: 'Agonista o antagonista de receptor', definition: 'Un activador activa un receptor biológico y genera una señal; un antagonista bloquea o reduce esa respuesta.' },
  ...
  { term: 'Vida media en investigación', definition: 'Tiempo necesario para que la mitad de un producto se elimine o degrade dentro de un modelo de investigación.' },
  ...
  { term: 'Secretagogo', definition: 'Sustancia que provoca la secreción de otra; por ejemplo, un producto que estimula la liberación de hormona de crecimiento.' },
]
