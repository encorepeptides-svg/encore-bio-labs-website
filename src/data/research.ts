...
export const researchArticles: ResearchArticle[] = [
  ...
  { slug: 'klow-kit-logistics', title: 'KLOW: A Four-Compound Regenerative Blend', description: 'How GHK-Cu, BPC-157, TB-500, and KPV are combined in one regenerative research entry.', contentType: 'deep-dive', categorySlug: 'recovery-regeneration', href: '/products/klow' },
