...
export const researchArticles: ResearchArticle[] = [
  ...
  { slug: 'copper-peptides-101', title: 'Copper Peptides 101: GHK-Cu, AHK-Cu, and Matrix-Remodeling Research', description: 'The shared and distinct research context behind two copper-peptide products.', contentType: 'deep-dive', categorySlug: 'recovery-regeneration', href: '/products/ghk-cu' },
  ...
  { slug: 'semax-selank-cognitive', title: 'Semax and Selank: Two Neuropeptides in Cognitive Research', description: 'Structurally distinct products commonly reviewed together in cognitive research.', contentType: 'deep-dive', categorySlug: 'cognitive-performance', href: '/products/semax' },
  ...
  { slug: 'hcg-fertility hormone-story', title: 'HCG and the Fertility hormone Research Story', description: 'LH/CG receptor signaling and gonadal steroidogenesis research.', contentType: 'deep-dive', categorySlug: 'hormone-wellness', href: '/products/hcg' },
  { slug: 'understanding-dsip', title: 'Understanding DSIP: Sleep, Brain-hormone Signaling, and Research Context', description: 'Sleep-architecture models and brain-hormone research relevance.', contentType: 'deep-dive', categorySlug: 'hormone-wellness', href: '/products/dsip' },
  ...
  { slug: 'klow-kit-logistics', title: 'KLOW: A Four-Product Regenerative Blend', description: 'How GHK-Cu, BPC-157, TB-500, and KPV are combined in one regenerative research entry.', contentType: 'deep-dive', categorySlug: 'recovery-regeneration', href: '/products/klow' },
  { slug: 'retatrutide-triple-receptor', title: "Retatrutide's Triple-Receptor Design: What Sets It Apart", description: 'The research context behind a triple GLP-1/GIP/glucagon activator.', contentType: 'deep-dive', categorySlug: 'metabolic-weight-management', href: '/products/retatrutide' },
  { slug: 'cjc1295-ipamorelin-studied-as-one', title: 'CJC-1295 and Ipamorelin: Why Two GH-Axis Peptides Are Studied as One', description: 'The GHRH-plus-secretagogue research logic behind pairing these two products.', contentType: 'deep-dive', categorySlug: 'metabolic-weight-management', href: '/products/cjc1295-ipamorelin' },
  ...
  { slug: 'cjc-ipamorelin-vs-tesamorelin', title: 'CJC-1295/Ipamorelin vs. Tesamorelin: Comparing GH-Axis Research Approaches', description: 'A dual-signal combination compared with a single-product approach.', contentType: 'comparison', categorySlug: 'metabolic-weight-management', href: '/categories/metabolic-weight-management' },
  ...
  { slug: 'peptides-vs-small-molecules', title: 'Peptides vs. Small-Molecule Products: What\'s the Difference?', description: 'A foundational distinction for anyone new to this catalog.', contentType: 'beginner', categorySlug: 'general', href: '/faq#product-categories' },
  ...
  { slug: 'why-lab paperwork-matters', title: 'Why Lab paperwork Matters More Than Marketing Claims', description: 'What to actually ask for before trusting a research-use catalog.', contentType: 'beginner', categorySlug: 'general', href: '/quality' },
  ...
  { slug: 'storage-handling-basics', title: 'Storage and Handling Basics for Research Products', description: 'A conceptual starting point before you dig into product-specific guidance.', contentType: 'beginner', categorySlug: 'general', href: '/faq#storage' },
...
export const glossaryTerms: GlossaryTerm[] = [
  ...
  { term: 'Peptide', definition: 'A short chain of amino acids linked together — smaller than a full protein, and the structural basis for most products in this catalog.' },
  { term: 'Lyophilization', definition: 'A freeze-drying process that removes water from a product to stabilize it for storage, producing the powder or cake form found in most vials.' },
  { term: 'Reconstitution', definition: 'The process of dissolving a lyophilized product into a liquid diluent before it can be used in a research setting.' },
  ...
  { term: 'Receptor Activator / Antagonist', definition: 'An activator activates a biological receptor to produce a signaling response; an antagonist blocks or dampens that same response.' },
  ...
  { term: 'Half-Life (Research Context)', definition: 'The time it takes for half of a product to be cleared or broken down in a research model — a common comparison point between related products.' },
  ...
  { term: 'Secretagogue', definition: 'A substance that triggers another substance to be secreted — for example, a product that prompts the release of growth hormone.' },
]
