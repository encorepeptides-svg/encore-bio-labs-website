...
export const researchArticles: ResearchArticle[] = [
  ...
  { slug: 'bpc157-tb500-together', title: 'BPC-157 and TB-500: How Two Repair Peptides Are Studied Together', description: 'Why these two research peptides are so often reviewed as a pair.', contentType: 'deep-dive', categorySlug: 'recovery-regeneration', href: '/products/bpc-157' },
  ...
  { slug: 'igf1-lr3-explained', title: 'IGF-1 LR3 Explained: Receptor Binding and Research Applications', description: 'A long-acting IGF-1 analog and its receptor-signaling research context.', contentType: 'deep-dive', categorySlug: 'cognitive-performance', href: '/products/igf1-lr3' },
  ...
  { slug: 'tb-500-on-its-own', title: 'TB-500 on Its Own: Actin Regulation Beyond the BPC-157 Pairing', description: "A closer look at TB-500's standalone research context in cytoskeletal and cell-migration biology.", contentType: 'deep-dive', categorySlug: 'recovery-regeneration', href: '/products/tb-500' },
  ...
  { slug: 'wolverine-vs-individual', title: 'Wolverine Stack vs. Individual BPC-157/TB-500: When Researchers Choose a Combination', description: 'What changes when two compounds are packaged as one kit.', contentType: 'comparison', categorySlug: 'recovery-regeneration', href: '/categories/recovery-regeneration' },
